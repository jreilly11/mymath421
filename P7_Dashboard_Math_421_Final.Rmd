...
```{r}
radioButtons(inputId = "age_range_input", 
             label = h2("Select Age Range"),
             choices = ufc_age_range,
             inline = TRUE,
             selected = '19-30')
```
